...
|抖音火山版|5|<li>开屏广告<li>更新提示<li>全屏广告<li>其他-休息提醒<li>青少年模式|
...
|搜狗输入法|1|<li>开屏广告|
|搜狐视频|1|<li>更新提示|
|搜狐新闻|5|<li>开屏广告<li>更新提示<li>全屏广告-弹窗广告<li>分段广告-信息流广告<li>权限提示-通知权限|
|搜索|1|<li>局部广告-卡片广告|
|搜图神器|1|<li>更新提示|
|苏打校园|1|<li>全屏广告-弹窗广告|
...
|UU加速器|4|<li>开屏广告<li>更新提示<li>全屏广告-弹窗广告<li>权限提示-通知权限|
|UU远程|1|<li>权限提示-通知提示|
